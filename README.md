...
But for these WORDPRESS + MySQL + PhpMyAdmin examples, you can choose Docker compose as your deployment method.

### Step 3: Select Docker compose example

After selecting a deployment select WORDPRESS + MySQL + PhpMyAdmin as your docker-compose example
